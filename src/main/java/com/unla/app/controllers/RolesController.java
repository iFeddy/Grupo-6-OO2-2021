...
public class RolesController {
    ...
    @GetMapping({"/roles/create", "create", "roles.create"})
  ...
  //POST Guardar Role Nuevo
  	@PostMapping({"/roles", "store", "roles.store"})
  ...
  //GET Editar Role
    @GetMapping({"/roles/edit/{id}", "edit", "roles.edit"})
    ...
    //POST Editar Role
   	@PostMapping({"/role/{id}", "update", "role.update"})
